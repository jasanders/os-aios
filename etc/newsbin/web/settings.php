...
$ServerConfigFile='/usr/local/etc/newsbin/conf/nzbget.conf';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$ServerConfigTemplate='/usr/local/etc/newsbin/conf/nzbget.conf.example';
...
$ServerStartCommand='/usr/local/etc/newsbin/bin/nzbget -D -c /usr/local/etc/newsbin/conf/nzbget.conf 2>&1';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$NzbDir='/usr/local/etc/newsbin/nzb';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$PostProcessConfigFile='/usr/local/etc/newsbin/conf/unpak.cfg';
...
#
# NOTE: Backslashes (on Windows) must be doubled.
$PostProcessConfigTemplate='/usr/local/etc/newsbin/conf/unpak.cfg.example';
