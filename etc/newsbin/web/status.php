...
function currently_downloading ($phpvars) {
	...
	if (isset($phpvars['activegroup'])) {
		...
		echo '<tr><td colspan="'.($supportpostparam ? 8 : 7).'"></td><td>name</td><td width="20">category</td><td width="50" align="right">age</td><td width="100" align="right">download rate</td><td width="60" align="right">left</td><td width="100" align="right">remaining time</td></tr>';
