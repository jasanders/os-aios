...
<script type="text/javascript"><!--
	...
	function statusLoaded()
	{
		if (document.getElementById('serverinfohidden')) {
			...
			document.getElementById('serverinfo').innerHTML='<center>Server information</center><br>'
		}
		if (document.getElementById('servercommandhidden')) {
			...
			document.getElementById('servercommand').innerHTML='<center>Server control</center><br>'
		}
